...
function checkDilationChallenges() {
  if (player.resets > 4) {
    document.getElementById("onions1").style.display = ""
  } else {
...
function init() {
    ...
    document.getElementById('onionsbtn').onclick = function () {
        showTab('onion');
    };
